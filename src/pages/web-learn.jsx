...
Transorming your visions into powerful Web Experiences
          ...
          <p className='icon-learnmore mb-1'><img src={imgIcon} alt="img" /> Scalable Design</p>
          <p className='icon-learnmore'><img src={imgIcon} alt="img"/> Inituative UI/UX</p>
          ...
          <Row className='d-flex justify-content-between '>
            ...
            <Row style={{fontSize:"13px"}}>
                ...
                <img src={imgIcon} alt="icon" style={{width:"30px"}} />
                </Col>
                <Col>
              Discovery & Planning wireframing! Design Custom Coding (Front-end & Back-end)
                </Col>
            </Row>
            </Col>
            <Col className='col-6'>
...
<Col > QA Testing <br /> prototype and deployement & Launch</Col>
                </Row>
            ...
            <Col className='col-'>
            <Row style={{fontSize:"13px"}}>
                <Col className='col-1 me-2 h-100'>
                <img src={imgIcon} alt="icon" style={{width:"30px"}} />
                </Col>
<Col  className='h-100 '> QA Testing <br /> Wireframing Ludbok QA Testing (&fixing) <br /> Deployment & Launch Post Launch support</Col>
                </Row>
